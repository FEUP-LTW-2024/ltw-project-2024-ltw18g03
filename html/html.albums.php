...
<?php function drawCard(Album $album, Session $session) { ?>
    <div class="card">
        ...
        <div class="desc">
            ...
            <p><?php echo $album->quantity; ?> from <?php echo number_format((float)$album->minPrice, 2, '.', ''); ?>€</p>
            <?php else: ?>
            <p>Out of stock</p>
            <?php endif; ?>
        </div>
    ...
    <div class="album_wrapper">
        <div class="album">
            ...
            <div class="album_prices">
                ...
                <p><?php echo $album->quantity; ?> albums from <?php echo number_format((float)$album->minPrice, 2, '.', ''); ?>€ </p>
            </div>
        </div>
        <div class="items">
            <div class="top">
